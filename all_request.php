            ...
            <div class="col-md-9 main-text">
                ...
                <div class="admin-right">
                    ...
                    <table border="2" style="border:2 #8a8a8a;">
                        <tr>
                            <td style="width: 170px; background: rgb(215, 248, 152)">Имя</td>
                            <td style="width: 170px; background: rgb(215, 248, 152)">Почта</td>
                            <td style="width: 150px; background: rgb(215, 248, 152)">Телефон</td>
                            <td style="width: 200px; background: rgb(215, 248, 152)">Сообщение</td>
                            <td style="width: 70px; background: rgb(152, 218, 248)">Ред</td>
                            <td style="width: 70px; background: rgb(248, 191, 152)">Удалить</td>
                        </tr>
                        ...
                        $rows = mysqli_query($mysqli, "SELECT name, email, tel, text FROM `Request`");
